...
# ZP_UCS--DUB-D-UC2 : Energy consumption tracking and optimization.
...
DUB-D-UC2 aims at tracking energy consumers within the Dublin Living Lab. This use case focuses on monitoring the energy consumption patterns of various devices and systems within the lab, providing insights into how energy is utilized across different applications. By analyzing this data, the Digital Twin can help identify trends and anomalies in energy usage, enabling better management and optimization of energy resources. The goal is to enhance the overall energy efficiency of the Living Lab by understanding the consumption behaviors of its energy consumers.
