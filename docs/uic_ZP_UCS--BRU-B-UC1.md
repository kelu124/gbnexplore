---
layout: default
title: ZP_UCS--BRU-B-UC1
has_children: true
nav_order: 32
---


# ZP_UCS--BRU-B-UC1 : Information platform for energy communities.
...
BRU-B-UC1 aims at providing an information platform to the Energy Community, recognizing that information often falls short of participants' expectations. The Digital Twin (DT) will offer users a set of information to support the activities of the energy community, primarily focusing on electricity and various types of renewable energy, as well as storage systems. The platform will cover social aspects by providing best practices for setting up an energy community and engagement manuals. Additionally, it will aggregate and consolidate energy data from the Local Energy Community (LEC), including energy costs, production, and consumption metrics. The DT will also provide cognitive models of participants, ESG data for sustainability reporting, benchmarks for asset optimization, guidance on selecting IoT devices, and a database for energy performance audits and recommendations. Overall, the platform aims to enhance the management and operation of the energy community by providing comprehensive and accessible information.
