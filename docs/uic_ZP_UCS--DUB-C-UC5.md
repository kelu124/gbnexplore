---
layout: default
title: ZP_UCS--DUB-C-UC5
has_children: true
nav_order: 37
---


# ZP_UCS--DUB-C-UC5 : Dublin environment quality monitoring tool.
...
DUB-C-UC5 aims at tracking environment quality enhancing artefacts within the Dublin Living Lab. This use case focuses on monitoring various elements that contribute to the overall quality of the environment in the lab, ensuring that the conditions are conducive to the well-being of its occupants. By utilizing the digital twin, the system will gather data on these artefacts, allowing for analysis and optimization of their impact on the environment. This process is intended to enhance the living conditions and promote a healthier atmosphere for users in the lab.
