---
layout: default
title: ZP_UCS--BRU-C-UC1
has_children: true
nav_order: 18
---


# ZP_UCS--BRU-C-UC1 : Optimizing Brussels mobility for sustainability.
...
BRU-C-UC1 aims at finding the best mobility scenario and assessing their impacts within the context of Green Building Neighbourhoods (GBNs). This use case focuses on evaluating how different mobility options can enhance safety, quality of life, and energy consumption for the inhabitants of the Living Lab (LL). It seeks to utilize a Digital Twin (DT) to simulate and analyze various mobility scenarios, allowing decision-makers and mobility experts to understand the potential effects of changes in mobility patterns. The goal is to optimize the GBN's transportation network, ensuring it meets the needs of its users while promoting a healthier and more livable environment. The use case will be developed in collaboration with mobility partners to integrate their expertise and ensure that the DT effectively supports the transformation of mobility within the GBN.
