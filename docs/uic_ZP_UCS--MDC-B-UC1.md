---
layout: default
title: ZP_UCS--MDC-B-UC1
has_children: true
nav_order: 12
---


# ZP_UCS--MDC-B-UC1 : Electricity monitoring and sustainability reporting.
...
MDC-B-UC1 aims at monitoring the electricity production units within the Green Building Neighbourhood (GBN). The team responsible for GBN exploitation will utilize the Digital Twin (DT) to present a comprehensive electrical map of the GBN, with a particular focus on Building B. This map will illustrate the flow of electricity from production sources, such as roof solar panels and other electrical production units, through to various electrical devices and their consumption levels. The DT will provide a direct and global view of the electricity network status, including monitoring the power flow of each device, such as air conditioning, heating, ventilation, lighting, and elevators. Additionally, it will track electricity exchanges between Building B and other GBN buildings, as well as the electricity production from agrovoltaics and the consumption of e-bike and e-car charging stations.
