---
layout: default
title: ZP_UCS--PRG-A-UC1
has_children: true
nav_order: 33
---


# ZP_UCS--PRG-A-UC1 : Electricity monitoring for sustainable management.
...
PRG-A-UC1 aims at monitoring electricity production units within the Green Building Neighbourhood (GBN). The focus is on providing a comprehensive overview of the electrical flow from the production of electricity to its consumption across various devices within the buildings. This includes tracking the performance of solar panels and other electricity production units, as well as monitoring the energy consumption of devices such as air conditioning, heating, ventilation, lighting, and elevators. The objective is to give the technical staff responsible for the GBN exploitation a clear and direct view of the electricity network status, enabling them to manage and optimize energy use effectively.
