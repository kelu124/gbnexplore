---
layout: default
title: ZP_UCS--BRU-A-UC2
has_children: true
nav_order: 20
---


# ZP_UCS--BRU-A-UC2 : Electricity monitoring for sustainable efficiency.
...
BRU-A-UC2 aims at monitoring electricity production units within the Green Building Neighbourhood (GBN) by providing a comprehensive view of the electrical flow from production to consumption. The Digital Twin (DT) will display the status of the electricity network, focusing on Building B, and will track the power flow from various sources, including roof solar panels and other electrical production units. It will also monitor the electricity consumption of devices such as air conditioning, heating, ventilation, lighting, and elevators. The perimeter of this monitoring includes all electricity flows within Building B, exchanges with other GBN buildings, and the production and consumption related to agrovoltaics and charging stations for e-bikes and e-cars. The technical staff responsible for GBN exploitation will primarily utilize this DT, although professors and students may also access it based on their permissions.
