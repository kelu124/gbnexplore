---
layout: default
title: ZP_UCS--BRU-A-UC3
has_children: true
nav_order: 44
---


# ZP_UCS--BRU-A-UC3 : Building climate monitoring and optimization.
...
BRU-A-UC3 aims at monitoring air flow and internal climate within Building B of the Green Building Neighbourhood. The Digital Twin (DT) will provide a comprehensive view of the building's internal spaces, focusing on the dynamic status of the internal climate. It will incorporate data from HVAC and ventilation systems to maintain target temperatures and regulate humidity and air quality. The DT will visualize key parameters such as temperature, humidity, CO2 levels, and volatile organic compounds (VOCs), as well as the air flow exchange between Building B and other buildings within the GBN. The primary users of this DT will be the technical staff responsible for the exploitation of the GBN, along with professors and students who may access the information based on their granted permissions.
