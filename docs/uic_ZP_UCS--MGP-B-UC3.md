---
layout: default
title: ZP_UCS--MGP-B-UC3
has_children: true
nav_order: 29
---


# ZP_UCS--MGP-B-UC3 : Optimizing Madrid's District Heating System.
...
MGP-B-UC3 aims at helping decision-makers manage the District Heating and Cooling Network (DHCN) by providing them with the necessary information to make informed decisions. This use case focuses on calculating key performance indicators (KPIs) that are essential for the DHCN's decision support system. By analyzing these KPIs, the system can offer optimization guidelines that assist in the effective management of the DHCN, ensuring that it operates efficiently and meets the heating and cooling demands of the connected buildings.
