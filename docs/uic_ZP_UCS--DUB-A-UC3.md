---
layout: default
title: ZP_UCS--DUB-A-UC3
has_children: true
nav_order: 26
---


# ZP_UCS--DUB-A-UC3 : HVAC performance monitoring in Dublin.
...
DUB-A-UC3 aims at managing and monitoring the performance of HVAC (Heating, Ventilation, and Air Conditioning) systems within the Dublin Living Lab. The use case focuses on observing the internal climate conditions of the building, which includes maintaining target temperatures through central heating and air conditioning, as well as regulating humidity and air quality through ventilation systems. The digital twin will visualize the air flow and provide data on various internal climate parameters such as temperature, humidity, CO2 levels, and volatile organic compounds (VOCs). This information will be accessible to the technical staff responsible for the building's management, as well as to professors and students, depending on their granted access. The goal is to ensure optimal indoor environmental conditions while facilitating effective monitoring and management of the HVAC systems.
