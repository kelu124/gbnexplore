---
layout: default
title: ZP_UCS--MGP-B-UC2
has_children: true
nav_order: 46
---


# ZP_UCS--MGP-B-UC2 : KPI optimization for efficient management.
...
MGP-B-UC2 aims at providing KPI optimization guidelines for the District Heating and Cooling Network (DHCN). The objective is to assist decision-makers in managing the DHCN effectively by offering insights and recommendations based on the calculated Key Performance Indicators (KPIs). This use case focuses on ensuring that the DHCN operates efficiently and meets the energy demands of the connected buildings while optimizing performance and resource utilization.
