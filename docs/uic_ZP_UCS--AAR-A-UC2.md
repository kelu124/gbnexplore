...
# ZP_UCS--AAR-A-UC2 : Human-centered design feedback tool.
...
AAR-A-UC2 aims at providing feedback on human-centered "soft" criteria during the early design stage of The Kitchen 2.0 and BSS buildings. This use case focuses on ensuring that the design team, which includes architects, receives insights into the qualitative aspects of occupant experience, such as comfort and well-being, as they develop their designs. The goal is to integrate these human-centered criteria into the design process to enhance the overall quality of the buildings and ensure they meet the needs of future occupants. By addressing these soft criteria early on, the design team can make informed decisions that positively impact the user experience in the completed buildings.
