---
layout: default
title: ZP_UCS--DUB-A-UC1
has_children: true
nav_order: 43
---


# ZP_UCS--DUB-A-UC1 : Environmental monitoring for sustainable buildings.
...
DUB-A-UC1 aims at monitoring external environmental conditions within the Dublin Living Lab. This use case focuses on collecting data related to the surrounding environment to assess its impact on the building's performance and occupant experience. By implementing a system that tracks various environmental factors, the goal is to enhance the understanding of how these conditions affect energy consumption, comfort levels, and overall sustainability of the building. The insights gained from this monitoring will inform future design and operational decisions, ultimately contributing to improved energy efficiency and occupant satisfaction in the Living Lab context.
