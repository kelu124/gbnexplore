---
layout: default
title: ZP_UCS--PRG-A-UC2
has_children: true
nav_order: 53
---


# ZP_UCS--PRG-A-UC2 : Electricity monitoring in Prague neighborhood.
...
PRG-A-UC2 aims at monitoring electricity production units within the Green Building Neighbourhood (GBN). The objective is to provide the team responsible for GBN exploitation with a comprehensive view of the electrical flow, starting from the production of electricity through to its transfer and consumption by various electrical devices. The Digital Twin (DT) will present a global electrical map of the GBN, focusing particularly on Building B, and will track the power flow of each device, including solar panels, air conditioning, heating, ventilation, lighting, and elevators. This monitoring will encompass all electricity flows within Building B, as well as exchanges with other GBN buildings, and will also account for electricity production from agrovoltaics and consumption at e-bike and e-car charging stations. The primary users of this system will be the technical staff in charge of GBN exploitation, along with professors and students who may access the DT based on their granted permissions.
