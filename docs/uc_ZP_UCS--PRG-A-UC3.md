...
# ZP_UCS--PRG-A-UC3 : Monitoring indoor climate and air quality.
...
PRG-A-UC3 aims at monitoring air flow and internal climate within Building B of the Green Building Neighbourhood. The digital twin (DT) will provide a comprehensive view of the internal spaces, focusing on the performance of HVAC and ventilation systems. It will track key parameters such as temperature, humidity, CO2 levels, and volatile organic compounds (VOCs). The DT will also visualize air flow exchanges between Building B and other buildings within the GBN, allowing technical staff, professors, and students to access and analyze the internal climate data effectively. This monitoring will help ensure optimal indoor environmental conditions and support the management of air quality and comfort within the building.
