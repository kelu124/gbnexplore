---
layout: default
title: ZP_UCS--DUB-B-UC2
has_children: true
nav_order: 57
---


# ZP_UCS--DUB-B-UC2 : Monitoring electric vehicle charging stations.
...
DUB-B-UC2 aims at monitoring charging stations within the electric vehicle (EV) grid ecosystem of the Dublin Living Lab. This use case focuses on tracking the performance and usage of the charging stations to ensure efficient operation and to gather data on energy consumption patterns. By monitoring these stations, the digital twin can provide insights into the energy flow associated with EV charging, helping to optimize the overall energy management of the living lab and contribute to the sustainability goals of the project.
