---
layout: default
title: ZP_UCS--BRU-B-UC4
has_children: true
nav_order: 50
---


# ZP_UCS--BRU-B-UC4 : Interconnected Digital Twins for sustainability.
...
BRU-B-UC4 aims at interconnecting several Digital Twins (DTs) from different Green Building Neighbourhoods (GBNs) to create a large-scale DT that facilitates data exchange. This use case focuses on establishing a network of Energy Communities, allowing various initiatives from different locations to share information and integrate into a broader system. The interconnection will enable the Digital Twin platform to propose standards for data exchanges and provide access to tools that support the platform's functionalities. The primary actors involved are members of local Energy Communities who seek to learn from other communities, as well as community managers who aim to leverage the benefits of accessing a larger network. By connecting these communities, the use case fosters collaboration and knowledge sharing, ultimately enhancing the effectiveness of energy management and sustainability efforts across the GBNs.
