...
# ZP_UCS--BRU-B-UC3 : Energy management and community engagement.
...
BRU-B-UC3 aims at providing an information platform to support the activities of a Local Energy Community (LEC) by offering users a comprehensive set of information primarily focused on electricity and renewable energy. This use case recognizes that information often falls short of participants' expectations and seeks to address this by aggregating and consolidating various types of data. The platform will include best practices for setting up an energy community, engagement manuals, and technical information such as energy data related to costs, production, and consumption. Additionally, it will provide cognitive digital twins of participants, benchmarks for energy assets, and guidance on selecting appropriate IoT devices and technologies. Overall, the goal is to enhance the management and optimization of energy systems within the Living Lab context, facilitating a more efficient and informed energy community.
