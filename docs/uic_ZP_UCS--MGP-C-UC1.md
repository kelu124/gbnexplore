---
layout: default
title: ZP_UCS--MGP-C-UC1
has_children: true
nav_order: 16
---


# ZP_UCS--MGP-C-UC1 : KPI visualization and reporting tool.
...
MGP-C-UC1 aims at visualizing and reporting key performance indicators (KPIs) based on user profiles within the context of the Madrid Geothermal Plant Living Lab. The objective is to empower users by providing them with tailored insights into energy consumption and performance metrics, thereby enhancing their understanding and engagement with the energy management systems in place. This initiative seeks to facilitate informed decision-making and promote energy efficiency among users by presenting relevant data in a user-friendly manner.
