---
layout: default
title: ZP_UCS--MDC-A-UC1
has_children: true
nav_order: 23
---


# ZP_UCS--MDC-A-UC1 : Electricity monitoring for sustainable management.
...
MDC-A-UC1 aims at monitoring the electricity production units within the Green Building Neighbourhood (GBN). The team responsible for the GBN exploitation will utilize the Digital Twin (DT) to present a comprehensive electrical map of the GBN, with a particular focus on Building B. This map will illustrate the flow of electricity from production sources, such as solar panels, through to various electrical devices and their consumption levels. The DT will provide a direct and global view of the electricity network status, including monitoring the power flow of each device, such as air conditioning, heating, ventilation, lighting, and elevators, as well as electricity exchanges between Building B and other buildings within the GBN.
