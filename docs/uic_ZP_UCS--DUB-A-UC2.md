---
layout: default
title: ZP_UCS--DUB-A-UC2
has_children: true
nav_order: 49
---


# ZP_UCS--DUB-A-UC2 : Dublin's indoor environmental monitoring system.
...
DUB-A-UC2 aims at monitoring internal environmental conditions within the Dublin Living Lab. This use case focuses on utilizing the Digital Twin (DT) to track various parameters that affect the indoor climate, such as temperature, humidity, and air quality. The DT will integrate data from the HVAC and ventilation systems to ensure that the internal environment meets the desired standards. By visualizing the internal climate status, the DT will help users understand how these conditions evolve over time and enable them to manage and optimize the building's environmental performance effectively.
