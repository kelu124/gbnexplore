---
layout: default
title: ZP_UCS--AAR-B-UC1
has_children: true
nav_order: 48
---


# ZP_UCS--AAR-B-UC1 : Optimizing building performance and experience.
...
AAR-B-UC1 aims at checking the design-stage predictions when the building is in operation. The primary objective is to ensure that the final design of The Kitchen 2.0 and BSS meets the necessary criteria for occupant experience, environmental impacts, and financial costs. This involves generating new knowledge on the accuracy of the design rationale and intentions by comparing the predictions made during the design phase with the actual performance during the operational phase. The insights gained from this process will be used to inform future renovation stages and the design of other green building neighbourhoods, ultimately contributing to a more effective design process.
