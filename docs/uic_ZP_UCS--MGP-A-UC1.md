---
layout: default
title: ZP_UCS--MGP-A-UC1
has_children: true
nav_order: 28
---


# ZP_UCS--MGP-A-UC1 : Thermal demand forecasting tool.
...
MGP-A-UC1 aims at forecasting the thermal requirements needed to heat or cool rooms within the Madrid Geothermal Plant Living Lab. The objective is to accurately predict the thermal demands of the spaces to ensure efficient energy management and optimize the use of geothermal resources. This involves analyzing various factors that influence heating and cooling needs, allowing for better planning and operation of the heating and cooling systems in the living lab environment.
