---
layout: default
title: ZP_UCS--BRU-B-UC2
has_children: true
nav_order: 13
---


# ZP_UCS--BRU-B-UC2 : Energy management platform for communities.
...
BRU-B-UC2 aims at providing an information platform to the Energy Community, recognizing that information often falls short of participants' expectations. The Digital Twin (DT) will offer users sets of information to support the activities of the energy community, primarily focusing on electricity but also encompassing various types of renewable energy and storage systems. The platform will include social management information, such as best practices for setting up an energy community and engagement manuals, while also aggregating technical data like energy costs, production and consumption metrics. Additionally, it will provide cognitive digital twins of participants, ESG data for sustainability reporting, benchmarks for asset optimization, and guidance on selecting appropriate IoT devices and technologies. Overall, the DT aims to enhance the management and operation of the Local Energy Community by consolidating essential information and tools into a single accessible platform.
