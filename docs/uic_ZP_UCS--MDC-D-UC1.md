...
# ZP_UCS--MDC-D-UC1 : Energy monitoring in Madrid neighborhood.
...
MDC-D-UC1 aims at monitoring the energy consumption and production within the Madrid Living Lab, specifically focusing on the integration of renewable energy sources and energy efficiency measures in the context of the Green Building Neighbourhood. This use case involves the collection and analysis of data related to energy flows, including the performance of photovoltaic systems and other renewable energy technologies implemented in the area. The goal is to optimize energy management practices, enhance sustainability, and support the overall objectives of the Probono project by providing insights into energy usage patterns and enabling informed decision-making for future developments in the neighbourhood.
