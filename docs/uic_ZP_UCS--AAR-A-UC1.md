---
layout: default
title: ZP_UCS--AAR-A-UC1
has_children: true
nav_order: 47
---


# ZP_UCS--AAR-A-UC1 : Rapid feedback for sustainable design.
...
AAR-A-UC1 aims at providing rapid feedback on life cycle assessment (LCA) metrics during the early design stage of The Kitchen 2.0 and BSS buildings. The design team, which includes architects, requires information on estimated CO2 footprint, energy consumption, and other LCA metrics. However, the current designs lack specific details such as the materials used and their geometries. This use case focuses on addressing these gaps by enabling the design team to obtain timely and relevant LCA data to inform their design decisions effectively.
