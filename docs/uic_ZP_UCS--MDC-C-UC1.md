---
layout: default
title: ZP_UCS--MDC-C-UC1
has_children: true
nav_order: 19
---


# ZP_UCS--MDC-C-UC1 : Energy consumption monitoring in Madrid.
...
MDC-C-UC1 aims at monitoring the energy consumption of the buildings within the Madrid Living Lab, specifically focusing on the energy usage patterns and efficiency of the new constructions being developed as part of the Madrid Nuevo Norte urban development project. The use case involves collecting and analyzing data related to energy consumption in order to optimize energy management strategies and ensure that the buildings meet sustainability goals. By utilizing a digital twin, the project seeks to provide insights into energy performance, enabling stakeholders to make informed decisions that align with the principles of Green Building Neighbourhoods. This initiative is part of a broader effort to integrate innovative technologies and sustainable practices into urban development, ultimately contributing to a more energy-efficient and environmentally friendly urban landscape.
